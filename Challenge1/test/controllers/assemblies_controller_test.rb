...
class AssembliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assembly" do
    assert_difference("Assembly.count") do
      post assemblies_url, params: { assembly: { RAILS_ENV=montadora_development: @assembly.RAILS_ENV=montadora_development, name: @assembly.name } }
    end
  ...
  test "should update assembly" do
    patch assembly_url(@assembly), params: { assembly: { RAILS_ENV=montadora_development: @assembly.RAILS_ENV=montadora_development, name: @assembly.name } }
